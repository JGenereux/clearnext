...
export default function Dashboard({ onEnterFocus, onLogout }: DashboardProps) {
  ...
  const foliage = {
    ...
    // right: "https://unsplash.com/s/photos/relax-nature?auto=format&fit=crop&q=80&w=600"
    
    right:"https://images.unsplash.com/photo-1516655855035-d5215bcb5604?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?auto=format&fit=crop&q=80&w=600"
  };
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f0] flex font-sans selection:bg-emerald-100 selection:text-emerald-900 overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none z-50 overflow-hidden" aria-hidden="true">
        ...
        //   className="absolute -left-20 top-1/4 w-64 h-auto rotate-12 mix-blend-multiply opacity-40 lg:opacity-80 border rounded-md"
        className="absolute -left-20 top-1/4 w-64 h-auto rotate-12 mix-blend-multiply opacity-40 lg:opacity-80 border rounded-md"
style={{
